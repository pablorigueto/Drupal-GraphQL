...
/**
 * @DataProducer(
 *   id = "query_site_address",
 *   name = @Translation("Load Site Address"),
 *   description = @Translation("Loads a list of Site Address."),
 *   produces = @ContextDefinition("any",
 *     label = @Translation("SiteAddress connection")
 *   ),
 *   consumes = {
 ...
 * )
 */
class QuerySiteAddress extends DataProducerPluginBase implements ContainerFactoryPluginInterface {
   ...
   *
   * @return \Drupal\custom_graphql\Wrappers\QueryConnection
  ...
  public function resolve($offset, $limit, RefinableCacheableDependencyInterface $metadata) {
    ...
    $query->condition($entityType->getKey('bundle'), 'site_address');
